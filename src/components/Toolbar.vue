...
<template>
	<aside id="va-toolbar" class="flex flex-wrap items-center justify-center max-w-lg px-8 py-5 dark:bg-gray-800 bg-gray-200 rounded-lg shadow-toolbar border border-gray-700 gap-10 lg:max-w-3xl">
